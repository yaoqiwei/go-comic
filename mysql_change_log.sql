...
CREATE TABLE `comic_order_info_0`
(
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT NOT NULL ,
    `order_id` BIGINT NOT NULL  COMMENT '最后登录ip',
    `info` VARCHAR(50) NOT NULL COMMENT '订单信息',
    PRIMARY KEY (`id`) USING BTREE
)ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='订单信息表';
CREATE TABLE `comic_order_info_1`
(
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT NOT NULL ,
...
CREATE TABLE `comic_order_info_2`
(
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT NOT NULL ,
    `order_id` BIGINT NOT NULL  COMMENT '订单id',
...
CREATE TABLE `comic_order_info_3`
(
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT NOT NULL ,
    `order_id` BIGINT NOT NULL  COMMENT '订单id',
